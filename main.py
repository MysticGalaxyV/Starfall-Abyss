    ...
    async def option_select_callback(self, interaction: discord.Interaction):
        ...
        if option_id == "items" or option_id == "weapons" or option_id == "armor":
            ...
            if option_id == "weapons":
                filtered_items = [item for item in all_items if item.item_type.lower() == "weapon"]
            elif option_id == "armor":
                filtered_items = [item for item in all_items if item.item_type.lower() == "armor"]
            else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nContinuing with skill tree and trading system development...")import discord
from discord.ext import commands
from discord import app_commands
from discord.ui import Button, View, Select
import json
